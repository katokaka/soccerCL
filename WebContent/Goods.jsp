...
<body onload="Gocart()">
	<div id="backimg">
				...
				<table class="table table-bordered">
					<tr class="active">
						...
						<th class="col-xs-6 col-sm-6 col-md-6">特徴 <s:form
								...
								<tr class="active">
									<td><s:submit type="button" value="詳細へ" formaction="GoMatchDetailAction"/></td>
		...
		<a href="#top" id="coffee"></a> <br> <br> <br>
		<h2 align="center">
			<s:property value="#session.shopName" />
			商品一覧
		</h2>
		...
		<s:if
			test="%{#session.premiumId != null || #session.userName != null}">
			<div class="container">
				...
				<div align="center">
					...
					<p>
						...
						１人でもプレミア会員様がいましたら、お連れ様の分もお作りいただけます。<br>
						お好みの焙煎度、挽き方でお待ちしております♪
					</p>
				</div>
			</div>
			<br>
			...
			<div class="container">
				<table class="table table-bordered table-hover">
					<tr>
						...
						<th class="col-xs-1 col-sm-1 col-md-1">購入 <a
							id="premiumgazou"></a> <!-- スクロールでここまで飛ぶ --> <s:iterator
