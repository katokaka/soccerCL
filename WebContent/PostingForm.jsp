		...
		<div class="box box-large">
			...
			<div class="box-content">
				<center>
					...
					<form action="GoPostingConfirmAction" method="post">
						...
						<table>
							<tr>
								<td>お名前</td>
								<td><input type="text" name="postingName"></td>
							</tr>
							<tr>
								<td>メールアドレス</td>
								<td><input type="text" name="postingEmail"></td>
							</tr>
							<tr>
								<td>問い合わせ内容</td>
						...
						<s:submit class="btn" type="button"
							value="確認する" />
					</form>
				</center>
			</div>
